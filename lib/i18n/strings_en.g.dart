...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsFullScreenEn fullScreen = TranslationsFullScreenEn.internal(_root);
...
class TranslationsMainEn {
	...
	late final TranslationsMainErrorEn error = TranslationsMainErrorEn.internal(_root);
	late final TranslationsMainSuccessEn success = TranslationsMainSuccessEn.internal(_root);
}
...
class TranslationsGalleryEn {
	...
	late final TranslationsGalleryEmptyEn empty = TranslationsGalleryEmptyEn.internal(_root);

	/// en: 'Loading your coffee collection...'
	String get loading => 'Loading your coffee collection...';

	late final TranslationsGalleryDeleteEn delete = TranslationsGalleryDeleteEn.internal(_root);
	late final TranslationsGalleryErrorEn error = TranslationsGalleryErrorEn.internal(_root);
}
...
class TranslationsFullScreenEn {
	...
	late final TranslationsFullScreenImageInfoDialogEn imageInfoDialog = TranslationsFullScreenImageInfoDialogEn.internal(_root);
}
